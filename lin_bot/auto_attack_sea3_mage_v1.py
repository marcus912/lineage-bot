...
from bot_sea3_mage import Sea3MageBot, BotState
...
# load the detector
detector = YoloDetection('model/yolo/sea3.pt', conf=0.3)
# load yolo model
stair_detector = YoloDetection('model/yolo/stairs.pt', conf=0.5)
# load an empty Vision class
vision = Vision()
# initialize the bot
bot = Sea3MageBot((wincap.offset_x, wincap.offset_y), (wincap.w, wincap.h))
