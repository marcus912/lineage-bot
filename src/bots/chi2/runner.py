...
from src.bots.chi2.bot import Chi2Bot, BotState
...
def main():
    ...
    # load the detector
    detector = YoloDetection('models/yolo/chi2.pt', conf=0.5)
    # load yolo model
    stair_detector = YoloDetection('models/yolo/stairs2.pt', conf=0.5)
